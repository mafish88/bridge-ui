...
export TARA_ERC20_LOCKING_CONNECTOR_ADDRESS=${TARA_ERC20_LOCKING_CONNECTOR_ADDRESS:="0x6aA8f4644bAa008e1fD6A81d31aCCC1cCf13e339"}
export ETH_ERC20_LOCKING_CONNECTOR_ADDRESS=${ETH_ERC20_LOCKING_CONNECTOR_ADDRESS:="0x030f4671e48Fc2a0eE4BdA956B2Aba26F5b7F8A9"}
...
find $STATIC_FOLDER -type f -exec sed -i "s,NEXT_PUBLIC_TARA_ERC20_LOCKING_CONNECTOR_ADDRESS_STRING_REPLACE,$TARA_ERC20_LOCKING_CONNECTOR_ADDRESS,g" {} \;
find $STATIC_FOLDER -type f -exec sed -i "s,NEXT_PUBLIC_ETH_ERC20_LOCKING_CONNECTOR_ADDRESS_STRING_REPLACE,$ETH_ERC20_LOCKING_CONNECTOR_ADDRESS,g" {} \;
