...
export ETHEREUM_GRAPHQL_API=${ETHEREUM_GRAPHQL_API:="https://indexer.testnet.taraxa.io/subgraphs/name/bridge/ethereum"}
export TARAXA_GRAPHQL_API=${TARAXA_GRAPHQL_API:="https://indexer.testnet.taraxa.io/subgraphs/name/bridge/taraxa"}
